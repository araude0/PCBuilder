...
print('<html>')
print('<head>')
print('<link href="https://fonts.googleapis.com/css?family=Poppins:300,800&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">')
print('<link rel="stylesheet" href="./style.css">')
print('<title>EZ PC Builder</title>')
print('</head>')
print('<body class="bg2"    >')
print('<table style="width:60%; border: 2px solid #dddddd;text-align: left;">') 

print('<th style="font-size:16pt;  padding: 8px;">') # 1-1번칸
print('<font color="white "style="font-weight:700;">')
print('Category')
print('</font>')
print('</th>') #1-1번칸 종료

print('<th style="font-size:16pt;">') # 1-2번칸
print('<font color="white "style="font-weight:700;">')
print('Name')
print('</font>')
print('</th>') #1-2번칸 종료

print('<th style="font-size:16pt;">') # 1-3번칸
print('<font color="white "style="font-weight:700;">')
print('Price')
print('</font>')
print('</th>') #1-3번칸 종료
...
print('<font color="white "style="font-weight:500;">')
print('CPU')
print('</font>')
print('</td>')
...
print('<td>')
print('<font color="white "style="font-weight:500;">')
print(cpu.loc[c]['NAME'])
print('</font>')
print('</td>')

print('<td>')
print('<font color="white "style="font-weight:500;">')
print(cpu.loc[c]['PRICE'])
print('</font>')
print('</td>')
print('</tr>')
...
print('<td>')
print('<font color="white "style="font-weight:500;">')
print(ram.loc[r]['NAME'])
print('</font>')
print('</td>')

print('<td>')
print('<font color="white "style="font-weight:500;">')
print(ram.loc[r]['PRICE'])
print('</font>')
print('</td>')
print('</tr>')
...
print('<td>')
print('<font color="white "style="font-weight:500;">')
print(vga.loc[v]['NAME'])
print('</font>')
print('</td>')

print('<td>')
print('<font color="white "style="font-weight:500;">')
print(vga.loc[v]['PRICE'])
print('</font>')
print('</td>')
print('</tr>')
...
print('<td>')
print('<font color="white "style="font-weight:500;">')
print(psu.loc[p]['NAME'])
print('</font>')
print('</td>')

print('<td>')
print('<font color="white "style="font-weight:500;">')
print(psu.loc[p]['PRICE'])
print('</font>')
print('</td>')
print('</tr>')
...
print('<td>')
print('<font color="white "style="font-weight:500;">')
print(ssd.loc[s]['NAME'])
print('</font>')
print('</td>')

print('<td>')
print('<font color="white "style="font-weight:500;">')
print(ssd.loc[s]['PRICE'])
print('</font>')
print('</td>')
print('</tr>')
...
print('<td>')
print('<font color="white "style="font-weight:500;">')
print(hdd.loc[h]['NAME'])
print('</font>')
print('</td>')

print('<td>')
print('<font color="white "style="font-weight:500;">')
print(hdd.loc[h]['PRICE'])
print('</font>')
print('</td>')
print('</tr>')
...
print('<td>')
print('<font color="white "style="font-weight:500;">')
print(cpucooler.loc[cc]['NAME'])
print('</font>')
print('</td>')

print('<td>')
print('<font color="white "style="font-weight:500;">')
print(cpucooler.loc[cc]['PRICE'])
print('</font>')
print('</td>')
print('</tr>')
...
print('<td>')
print('<font color="white "style="font-weight:500;">')
print(case.loc[cs]['NAME'])
print('</font>')
print('</td>')

print('<td>')
print('<font color="white "style="font-weight:500;">')
print(case.loc[cs]['PRICE'])
print('</font>')
print('</td>')
print('</tr>')
...
print('<tr>')
print('<td style="padding: 8px;">')
print('<font color="white "style="font-weight:600;">')
print('총 합계')
print('</font>')
print('</td>')
...
print('<p align="center"><input type="submit" value="Back to Home" style="margin-right: 20px; width: 150px; height:25px;"></p>')
print('</form>')
print('</body>')
print('</html>')